							...
							<form class="form" action="" method="post">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<select class="form-control" name="seccion" id="login-seccion" required>
												<option value="">Selecciona sección...</option>
												<option value="CAÑADA DEL ENCINO">CAÑADA DEL ENCINO</option>
												<option value="HACIENDA DEL REY">HACIENDA DEL REY</option>
												<option value="HACIENDA VALLE DE LOS ENCINOS">HACIENDA VALLE DE LOS ENCINOS</option>
												<option value="LOMAS">LOMAS</option>
												<option value="VISTA DEL REY">VISTA DEL REY</option>
											</select>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Sección:</label>
											<input type="text" class="form-control mayusculas form-disabled" required maxlength="2" id="login-seccion-prefijo" readonly>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Manzana:</label>
											<input type="text" class="form-control mayusculas" name="manzana" required maxlength="3">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Lote:</label>
											<input type="text" class="form-control mayusculas" name="lote" required maxlength="3">
										</div>
									</div>
								</div>
								<div class="form-group">
