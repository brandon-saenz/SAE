...
var KTDashboard = function() {
    ...
    var dailySales = function() {
        ...
        var chartData = {
            labels: ["1 Feb", "2 Feb", "3 Feb", "4 Feb", "05 Feb", "06 Feb", "07 Feb", "08 Feb", "09 Feb"],
            datasets: [{
                label: 'Desempeño',
                backgroundColor: '#5CBAE5',
                data: [
                    23, 17, 6, 9, 10, 26, 31, 5, 8
                ]
            }, {
                ...
                label: 'Clima Laboral',
                backgroundColor: '#FAC364',
                data: [
                    5, 9, 16, 21, 25, 20, 21, 10, 1
                ]
            }, {
                backgroundColor: '#9EA8AD',
                label: 'NOM-035-STPS',
                data: [
                    15, 20, 25, 30, 25, 20, 15, 20, 25
                ]
            }]
        };
    ...
    var dailySales2 = function() {
        var chartContainer = KTUtil.getByID('kt_chart_daily_sales2');
        ...
        var chartData = {
            labels: ["26-35 años", "18-25 años", "46-55 años", "+56 años", "36-45 años"],
            datasets: [{
                label : "",
                data: [9.3, 9.2, 8.4, 8.2, 7.0],
                fill: false,
                backgroundColor: [
                    '#114E8B',
                    '#114E8B',
    ...
    var dailySales3 = function() {
        var chartContainer = KTUtil.getByID('kt_chart_daily_sales3');
    ...
    var dailySales4 = function() {
        var chartContainer = KTUtil.getByID('kt_chart_daily_sales4');
        ...
        var chartData = {
            labels: ["Ventas", "Contabilidad", "Compras", "Administración", "Almacén"],
            datasets: [{
                label : "",
                data: [9.5, 9.1, 8.4, 8.1, 6.2],
                fill: false,
                backgroundColor: [
                    '#114E8B',
                    '#114E8B',
