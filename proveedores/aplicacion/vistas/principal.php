		...
		<div class="card card-custom gutter-b card-stretch">
			...
			<div class="card-body d-flex flex-column">
				...
				<div style="position: relative; margin-top: -25px;">
					...
					<div class="label label-inline label-lg font-weight-bolder label-rounded label-primary" style="padding: 25px 5px; width: 100%;">Status de Proveedor:<br /> Aprobado</div>
					<p class="text-center font-weight-normal font-size-lg mt-5">
						Has sido aprobado como proveedor, aún está pendiente la firma por parte de autorización para que puedas cargar facturas.
				    </p>
					...
					<p class="text-center font-weight-normal font-size-lg mt-5">
						La información enviada está en proceso de revisión. Una vez aprobada podrás subir tus facturas a nuestra plataforma.
				    </p>
			...
			<div class="card-body">
				<div class="mt-n12">
					...
					<div class="d-flex align-items-center">
						...
						<div class="d-flex flex-column flex-grow-1 py-2">
							<a href="<?php echo STASIS; ?>/perfil/datos/ac" class="text-hover-primary <?php if ($datos['ac'] == 1) echo 'text-info'; else echo 'text-dark-75'; ?>">Subir archivo de Acta Constitutiva - Sociedades Anónimas o SA CV.</a>
						</div>
					</div>
					<div class="d-flex align-items-center">
						<label class="checkbox checkbox-lg checkbox-primary flex-shrink-0 m-0 mr-4 checkbox-nocursor">
					...
					<div class="d-flex align-items-center">
						...
						<div class="d-flex flex-column flex-grow-1 py-2">
							<a href="<?php echo STASIS; ?>/perfil/datos/iorl" class="text-hover-primary <?php if ($datos['iorl'] == 1) echo 'text-info'; else echo 'text-dark-75'; ?>">Subir archivo de la Identificación Oficial del Representante Legal.</a>
						</div>
					</div>
					<div class="d-flex align-items-center">
						<label class="checkbox checkbox-lg checkbox-primary flex-shrink-0 m-0 mr-4 checkbox-nocursor">
					...
					<div class="d-flex align-items-center">
						...
						<div class="d-flex flex-column flex-grow-1 py-2">
							<a href="<?php echo STASIS; ?>/perfil/datos/eoss" class="text-hover-primary <?php if ($datos['eoss'] == 1) echo 'text-info'; else echo 'text-dark-75'; ?>">Subir archivo del comprobante de pago al seguro social en caso de empresas outsourcing y lista de personal registrado en el Seguro Social.</a>
						</div>
					</div>
					<div class="d-flex align-items-center">
						<label class="checkbox checkbox-lg checkbox-primary flex-shrink-0 m-0 mr-4 checkbox-nocursor">
							<input type="checkbox" disabled value="1" <?php if ($datos['pep'] == 1) echo 'checked'; ?> />
							<span></span>
						</label>
						<div class="d-flex flex-column flex-grow-1 py-2">
							<a href="<?php echo STASIS; ?>/perfil/datos/pep" class="text-hover-primary <?php if ($datos['pep'] == 1) echo 'text-info'; else echo 'text-dark-75'; ?>">Subir archivo del la notificación a proveedores y evaluación de proveedores.</a>
						</div>
					</div>
					<?php
					}
