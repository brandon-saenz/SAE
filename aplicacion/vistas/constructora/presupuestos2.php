				...
				<div class="card-body">
					...
					<div class="accordion accordion-toggle-arrow" id="accordionExample4">
						...
						foreach ($arregloPartidas as $partida) {
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseOne<?php echo $x; ?>">
									<i class="flaticon2-layers-1"></i>User Permissions</div>
								</div>
								<div id="collapseOne<?php echo $x; ?>" class="collapse" data-parent="#accordionExample4" style="">
									<div class="card-body">
