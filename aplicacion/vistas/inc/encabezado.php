                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            <ul class="menu-nav">
                                ...
                                <?php
                                if ($_SESSION['login_adminglobal'] == 0) {
                                    ...
                                    <!-- Cobranza -->
                                    <!-- Marlon, Marco, Eduardo, Rosa -->
                                    <?php
                                    if ($_SESSION['login_id'] == 1 || $_SESSION['login_id'] == 1373 || $_SESSION['login_id'] == 1265 || $_SESSION['login_id'] == 1257 || $_SESSION['login_id'] == 1174 || $_SESSION['login_id'] == 1174 || $_SESSION['login_id'] == 1268 || $_SESSION['login_id'] == 1275 || $_SESSION['login_id'] == 1207 || $_SESSION['login_id'] == 1225) {
                                    ?>
                                        <li class="menu-item menu-item-submenu <?php if ($menu1 == 'cobranza') echo 'menu-item-active menu-item-open'; ?>" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="javascript:;" class="menu-link menu-toggle" style="">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    if ($_SESSION['login_id'] == 1 || $_SESSION['login_id'] == 1373 || $_SESSION['login_id'] == 1265 || $_SESSION['login_id'] == 1257 || $_SESSION['login_id'] == 1174 || $_SESSION['login_id'] == 1174 || $_SESSION['login_id'] == 1268 || $_SESSION['login_id'] == 1275 || $_SESSION['login_id'] == 1207 || $_SESSION['login_id'] == 1225) {
                                                    ?>
                                                    <li class="menu-item <?php if ($menu2 == 'reporteMovimientos') echo 'menu-item-active'; ?>" aria-haspopup="true">
                                                    ...
                                                    ?>
                                                    <li class="menu-item menu-item-submenu <?php if ($menu2 == 'au') echo 'menu-item-active'; ?>" aria-haspopup="true" data-menu-toggle="hover">
                                                        <a href="<?php echo STASIS; ?>/cobranza/au" class="menu-link menu-toggle">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">Asociación de Usuarios</span>
                                                        </a>
                                                    </li>
                                                    <?php
                                                    }
