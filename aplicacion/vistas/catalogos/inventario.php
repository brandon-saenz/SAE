								...
								<table class="table table-bordered table-striped kt_datatable-2">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $datos['disponible']; ?></td>
											<td><?php echo $datos['m2']; ?></td>
											<td><?php echo $datos['importe_renta']; ?></td>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/campanas/modificar/<?php echo $datos['id']; ?>" class="navi-link">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/campanas/inactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
