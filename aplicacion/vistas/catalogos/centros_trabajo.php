	...
	<div class="col-xl-12">
		<div class="card card-custom gutter-b">
			<div class="card-header">
				<h3 class="card-title">
					<span class="card-label font-weight-bolder text-dark">Información del Centro de Trabajo</span>
				</h3>
			</div>
			...
			<form class="form" action="" method="post">
				<div class="card-body">
					<div class="form-group row">
						<label for="example-text-input" class="col-2 col-form-label">* Nombre de Centro de Trabajo</label>
						<div class="col-6">
							<input class="form-control mayusculas" type="text" name="nombre" required>
						</div>
					</div>
					<div class="form-group row">
						<label for="example-text-input" class="col-2 col-form-label">* Director</label>
						<div class="col-6">
							<select class="form-control" name="id_director" required>
								<?php echo $listadoUsuarios; ?>
							</select>
						</div>
					</div>
					<div class="form-group row">
						<label for="example-text-input" class="col-2 col-form-label">* Comprador</label>
						<div class="col-6">
							<select class="form-control" name="id_comprador" required>
								<?php echo $listadoUsuarios; ?>
							</select>
						</div>
					</div>
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<button type="submit" class="btn btn-primary">Agregar Centro de Trabajo</button>
							<a href="<?php echo STASIS; ?>/catalogos/centros_trabajo" class="btn btn-secondary">Regresar</a>
						</div>
					</div>
				</div>
			</form>
			...
			<form class="form" action="" method="post">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<select class="form-control" name="id_director" required>
								<?php echo $listadoUsuariosDirector; ?>
							</select>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-6">
							<select class="form-control" name="id_comprador" required>
								<?php echo $listadoUsuariosComprador; ?>
							</select>
						</div>
					</div>
				</div>
		...
		<div class="card card-custom gutter-b card-stretch ">
			<div class="card-header border-0">
				...
				<div class="card-toolbar">
					<a class="btn btn-light-primary btn-md py-2 font-weight-bolder" href="<?php echo STASIS; ?>/catalogos/centros_trabajo/nuevo"><i class="fa fa-plus"></i> Nuevo Centro de Trabajo</a>
				</div>
								...
								<table class="table table-bordered table-striped kt_datatable-2">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $datos['comprador']; ?></td>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/centros_trabajo/reactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
