	...
	<div class="col-xl-12">
		<div class="card card-custom gutter-b">
			<div class="card-header">
				<h3 class="card-title">
					<span class="card-label font-weight-bolder text-dark">Información del Servicio</span>
				</h3>
			</div>
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<a href="<?php echo STASIS; ?>/catalogos/servicios" class="btn btn-secondary">Regresar</a>
						</div>
					</div>
				</div>
			</form>
			...
			<form class="form" action="" method="post">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<select class="form-control" name="tipo" required>
								<option <?php if ($info->tipo == 'A') echo 'selected'; ?> value="A">ATENCIÓN</option>
								<option <?php if ($info->tipo == 'S') echo 'selected'; ?> value="S">SERVICIO</option>
							</select>
						</div>
					</div>
				</div>
		...
		<div class="card card-custom gutter-b card-stretch ">
			<div class="card-header border-0">
				...
				<div class="card-toolbar">
					<a class="btn btn-light-primary btn-md py-2 font-weight-bolder" href="<?php echo STASIS; ?>/catalogos/servicios/nuevo"><i class="fa fa-plus"></i> Nuevo Servicio</a>
				</div>
			</div>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/servicios/modificar/<?php echo $datos['id']; ?>" class="navi-link">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/servicios/inactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/catalogos/servicios/reactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
