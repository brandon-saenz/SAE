			...
			<div class="card-body">
				<div class="container pt-3">
			        ...
			        <div class="text-center" id="requieres">
			            <img src="<?php echo STASIS; ?>/img/casa.png" class="mb-5" />
			            <h1 class="fw-bold mb-5">¿Eres propietario en Residencial Rancho Tecate?</h1>

			            <div class="separator separator-dashed border-danger opacity-25 mb-5"></div>

			            <div class="d-flex flex-center flex-wrap">
			                <button id="norequiero" class="btn btn-success m-2"><i class="fa fa-times"></i> No soy propietario</button>
			                <button id="sirequiero" class="btn btn-primary m-2"><i class="fa fa-check"></i> Si soy propietario</button>
			            </div>
			        </div>
		                    	...
		                    	<div class="row">
		                    		<div class="col-md-7">
			                    		...
			                    		<div class="form-group">
			                    			...
			                    			<input type="text" class="form-control form-control-lg" id="fact-propietario" value="<?php echo $datos['propietario']; ?>">
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Número de Celular</label>
			                    			<input type="text" class="form-control form-control-lg" id="fact-correo" value="<?php echo $datos['email']; ?>">
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Correo</label>
			                    			<input type="text" class="form-control form-control-lg" id="fact-correo" value="<?php echo $datos['email']; ?>">
			                    		...
			                    		<div class="form-group">
			                    			<label># Boletos</label>
			                    			<input type="number" class="form-control form-control-lg" id="fact-lote" value="1">
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Concepto</label>
			                    			<input type="text" class="form-control form-control-lg" id="fact-concepto" value="Entrada Evento: Noche Mexicana">
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Importe a Pagar</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-importe" value="$ 700.00" readonly>
			                    		</div>
			                    	</div>
		                        </div>
		                    </div>
				...
				<!-- Info pago -->
				<div class="row" id="infopago2" style="display: none;">
					<div class="col-md-4">
