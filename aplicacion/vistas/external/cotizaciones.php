...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Pago de Cotización</title>
...
<!--begin::Header Mobile-->
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            ...
            <!--begin::Logo-->
            <a href="#">
                <img alt="Logo" src="img/cobroplan.png" height="18" />
            </a>
                    ...
                    <div id="kt_header" class="header header-fixed">
                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper" style=" margin-top: 9px;">
                                <a href="#">
					                <img alt="Logo" src="img/cobroplan.png" height="47" />
					            </a>
                            </div>
                            ...
                            <div class="topbar">
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">
                                        ...
                                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline"><?php echo $datos['propietario']; ?></span>
                                    </div>
                                </div>
		...
		<div class="card card-custom">
			<div class="card-body">
				<div class="container pt-3">
					...
					<!-- Requerir factura -->
			        <div class="text-center" id="requieres">
			            <img src="<?php echo STASIS; ?>/img/factura.png" class="mb-5" />
			            <h1 class="fw-bold mb-5">¿Requieres factura para tu pago?</h1>

			            <div class="separator separator-dashed border-danger opacity-25 mb-5"></div>

			            <div class="mb-9 text-dark">
			                En caso de no requerir factura, se generará una factura con RFC genérico el cuál se enviará a tu dirección de correo en un periodo de 24 horas.
			            </div>

			            <div class="d-flex flex-center flex-wrap">
			                <button id="norequiero" class="btn btn-success m-2"><i class="fa fa-times"></i> No requiero factura</button>
			                <button id="sirequiero" class="btn btn-primary m-2"><i class="fa fa-check"></i> Si requiero factura</button>
			            </div>
			        </div>

			        <!-- Nacional extranjero -->
			        <div class="text-center" id="tipo-requieres" style="display: none;">
			        	<img src="<?php echo STASIS; ?>/img/tipo-factura.png" class="mb-5" />
			            <h1 class="fw-bold mb-5">¿Eres persona física/moral o extranjero?</h1>

			            <div class="separator separator-dashed border-danger opacity-25 mb-5"></div>

			            <div class="mb-9 text-dark">
			                En caso de ser extranjero, se generará una factura con RFC genérico extranjero.
			            </div>

			            <div class="d-flex flex-center flex-wrap">
			                <button id="extranjero" class="btn btn-primary m-2">Extranjero</button>
			                <button id="personafisica" class="btn btn-primary m-2">Persona física/moral</button>
			            </div>
			        </div>

					<!-- Datos nacional -->
					<div class="row" id="datosnacional" style="display: none;">
						<div class="col-md-3"></div>
						<div class="col-md-6">
							<div class="text-center">
								<img src="<?php echo STASIS; ?>/img/facturacion.png" class="mb-5" />
								<h1 class="fw-bold mb-5">Introduce tus datos de facturación</h1>
							</div>
							
							<div class="separator separator-dashed border-danger opacity-25 mb-5"></div>

							<h3 class="font-size-lg text-dark font-weight-bold mb-6">1. Datos Principales</h3>

							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Razón Social:</label>
								<div class="controls col-sm-9">
									<input required type="text" class="form-control mayusculas" id="razon_social" name="razon_social" maxlength="255" >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* RFC:</label>
								<div class="controls col-sm-9">
									<input required type="text" class="form-control mayusculas" id="rfc" name="rfc" maxlength="30">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Uso CFDI:</label>
								<div class="controls col-sm-9">
									<select class="form-control" id="uso_cfdi" name="usoCfdi" required>
							...
							<h3 class="font-size-lg text-dark font-weight-bold mb-6 mt-15">2. Dirección</h3>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Calle:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas mayusculas" id="nombre_calle" name="nombre_calle" maxlength="60" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* No. Exterior:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas numeric" id="num_exterior" name="num_exterior" maxlength="30" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">No. Interior:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas" id="num_interior" name="num_interior" maxlength="30">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Colonia:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas" id="colonia" name="colonia" maxlength="60" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Código Postal:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas numeric" id="cp" name="cp" maxlength="6" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Ciudad:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas" id="ciudad" name="ciudad" maxlength="60" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">* Estado:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control mayusculas" id="estado" name="estado" maxlength="60" required >
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">País:</label>
								<div class="controls col-sm-9">
									<input type="text" class="form-control form-disabled" id="pais" name="pais" maxlength="60" readonly value="MÉXICO">
								</div>
							</div>

							<div class="d-flex flex-center flex-wrap">
				                <button id="fact-continuar" class="btn btn-primary m-2"><i class="fa fa-check"></i> Continuar</button>
				            </div>
						</div>
					</div>
				</div>
				...
				<!-- Info pago -->
				<div class="row" id="infopago" style="display: none;">
					<div class="col-md-4">
		                    	...
		                    	<div class="row">
		                    		<div class="col-md-7">
			                    		...
			                    		<div class="form-group">
			                    			...
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-propietario" value="<?php echo $datos['propietario']; ?>" readonly>
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Correo</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-correo" value="<?php echo $datos['email']; ?>" readonly>
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Lote</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-lote" value="<?php echo $datos['lote']; ?>" readonly>
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Concepto</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-concepto" value="<?php echo $datos['concepto']; ?>" readonly>
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Importe a Pagar</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-importe" value="$ <?php echo $datos['total'] . ' ' . $datos['moneda']; ?>" readonly>
			                    		</div>
			                    		<div class="form-group">
			                    			<label>Observaciones</label>
			                    			<input type="text" class="form-control form-control-solid form-control-lg" id="fact-observaciones" value="<?php echo $datos['observaciones']; ?>" readonly>

			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-moneda" value="<?php echo $datos['monedaRaw']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-subtotal" value="<?php echo $datos['subtotal']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-impuesto" value="<?php echo $datos['impuesto']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-total" value="<?php echo $datos['total']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-porimpuesto" value="<?php echo $datos['porImpuestoRaw']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-observaciones" value="<?php echo $datos['observaciones']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-idConcepto" value="<?php echo $datos['id_concepto']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-um" value="<?php echo $datos['um']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-umAbreviacion" value="<?php echo $datos['um_abreviacion']; ?>" readonly>
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="fact-claveProdserv" value="<?php echo $datos['clave_prodserv']; ?>" readonly>
			                    			
			                    			<input type="hidden" class="form-control form-control-solid form-control-lg" id="idCotizacion" value="<?php echo $datos['folio']; ?>" readonly>
