	...
	<div class="col-xl-12">
		<div class="card card-custom gutter-b">
			<div class="card-header">
				<h3 class="card-title">
					<span class="card-label font-weight-bolder text-dark">Información del Colaborador</span>
				</h3>
			</div>
			...
			<form class="form" action="" method="post" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="form-group row">
						<label for="example-search-input" class="col-2 col-form-label">Género</label>
						<div class="col-3">
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<a href="<?php echo STASIS; ?>/empleados/colaboradores" class="btn btn-secondary">Regresar</a>
						</div>
					</div>
				</div>
			</form>
			...
			<form class="form" action="" method="post" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="form-group row">
						<label for="example-search-input" class="col-2 col-form-label">Apellidos</label>
						<div class="col-3">
							<input class="form-control mayusculas" type="text" name="apellidos" value="<?php echo $info->apellidos; ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="example-search-input" class="col-2 col-form-label">Género</label>
						<div class="col-3">
							<select class="form-control" name="genero">
								<option value="">Selecciona un género...</option>
								<option <?php if ($info->genero == 1) echo 'selected'; ?> value="1">MASCULINO</option>
								<option <?php if ($info->genero == 2) echo 'selected'; ?> value="2">FEMENINO</option>
							</select>
						</div>
					</div>
					<div class="form-group row">
		...
		<div class="card card-custom gutter-b card-stretch ">
			<div class="card-header border-0">
				...
				<div class="card-toolbar">
					<a class="btn btn-light-primary btn-md py-2 font-weight-bolder" href="<?php echo STASIS; ?>/empleados/colaboradores/nuevo"><i class="fa fa-plus"></i> Nuevo Colaborador</a>
				</div>
								...
								<table class="table table-bordered table-striped kt_datatable-2">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $datos['jefe_directo']; ?></td>
											<td><?php echo $datos['puesto']; ?></td>
											<td><?php echo $datos['departamento']; ?></td>
											<td><?php echo $datos['centro_trabajo']; ?></td>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/colaboradores/modificar/<?php echo $datos['id']; ?>" class="navi-link">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/colaboradores/inactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/colaboradores/reactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
