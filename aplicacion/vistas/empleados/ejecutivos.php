	...
	<div class="col-xl-12">
		<div class="card card-custom gutter-b">
			<div class="card-header">
				<h3 class="card-title">
					<span class="card-label font-weight-bolder text-dark">Información del Ejecutivo</span>
				</h3>
			</div>
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<button type="submit" class="btn btn-primary">Agregar Ejecutivo</button>
							<a href="<?php echo STASIS; ?>/empleados/ejecutivos" class="btn btn-secondary">Regresar</a>
						</div>
					</div>
				</div>
			</form>
		...
		<div class="card card-custom gutter-b card-stretch ">
			<div class="card-header border-0">
				...
				<div class="card-toolbar">
					<a class="btn btn-light-primary btn-md py-2 font-weight-bolder" href="<?php echo STASIS; ?>/empleados/ejecutivos/nuevo"><i class="fa fa-plus"></i> Nuevo Ejecutivo</a>
				</div>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/ejecutivos/modificar/<?php echo $datos['id']; ?>" class="navi-link">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/ejecutivos/inactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/ejecutivos/reactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
