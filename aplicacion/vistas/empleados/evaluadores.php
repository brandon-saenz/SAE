		...
		<div class="card card-custom gutter-b">
			...
			<form class="form" action="" method="post" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="form-group row">
						<label for="example-search-input" class="col-2 col-form-label">¿Puede Autorizar Proveedores?</label>
						<div class="col-3">
							<select class="form-control" name="autorizar_proveedores">
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<a href="<?php echo STASIS; ?>/empleados/evaluadores" class="btn btn-secondary">Regresar</a>
						</div>
					</div>
				</div>
			</form>
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-3">
							<select class="form-control" name="autorizar_proveedores">
								<option value="">Selecciona opción...</option>
								<option <?php if($info->autorizar_proveedores == 0) echo 'selected'; ?> value="0">NO</option>
								<option <?php if($info->autorizar_proveedores == 1) echo 'selected'; ?> value="1">SI</option>
							</select>
						</div>
					</div>
					<div class="form-group row">
		...
		<div class="card card-custom gutter-b card-stretch ">
			<div class="card-header border-0">
				...
				<div class="card-toolbar">
					<a class="btn btn-light-primary btn-md py-2 font-weight-bolder" href="<?php echo STASIS; ?>/empleados/evaluadores/nuevo"><i class="fa fa-plus"></i> Nuevo Administrador</a>
				</div>
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/evaluadores/modificar/<?php echo $datos['id']; ?>" class="navi-link">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/evaluadores/inactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="<?php echo STASIS; ?>/empleados/evaluadores/reactivar/<?php echo $datos['id']; ?>" class="navi-link">
																	<span class="navi-icon">
